...
def routes(route_id: int):
        ...
        route_info = {"id": 3, "name": "whoa there pardner", "grade": 5, "attempts": 69, "sent": False}
...
def create_route():
    ...
    if request.method == 'POST':
        ...
        logic.add_route(route_name=route_name, route_grade=route_grade, creating_user=creating_user)
    return render_template('create_route.html', error=error, route_id=id)
